...
public class Initiation implements CommandLineRunner {
   ...
   @Autowired
    ...
    public void run(String... args) throws Exception {
        ...
        Post post1 = new Post(null, LocalDate.of(2023, 10, 1), "Título 1", "Conteúdo do post 1",user1);
        Post post2 = new Post(null, LocalDate.of(2023, 10, 2), "Título 2", "Conteúdo do post 2",user2);
        Post post3 = new Post(null, LocalDate.of(2023, 10, 3), "Título 3", "Conteúdo do post 3",user3);
